...
Partial Public Class FormRoleUser
            ...
            If Not ds Is Nothing Then
                With ds.Tables(0).Rows(0)
                    If Me._ID = 1 Then
                        ...
                        ckMenuSettingUser.Properties.ReadOnly = True
                    End If
                    ...
                    ckMenuSettingUser.Checked = CBool(.Item("MenuSettingUser"))
                End With
                ds.Dispose()
    ...
    Private Sub ckMenuSettingUser_CheckedChanged(sender As Object, e As EventArgs) Handles ckMenuSettingUser.CheckedChanged
        If Me._ID = 1 Then
            ckMenuSettingUser.Checked = True
        End If
    End Sub
End Class
