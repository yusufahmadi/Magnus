...
Public Class FormStokKeluar
    ...
    Public KodeDepan As String = "SK"
    Public TableMaster As String = "StokKeluar"
                                    ...
                                    If ObjToInt(GV1.GetRowCellValue(i, "IDBarang")) > 0 AndAlso ObjToInt(GV1.GetRowCellValue(i, "Qty")) > 0 Then
                                        If ObjToInt(GV1.GetRowCellValue(i, "ID")) <= 0 Then
                                            ...
                                            com.CommandText = "INSERT INTO [" & TableMaster & "D]
                                                            ...
                                                            ,[Jumlah]
                                                            ,[Catatan]) 
                                                            VALUES (@ID,@IDStokKeluar,@NoUrut,@IDBarang,@Qty,@IDSatuan,@Isi,@Harga,@Jumlah,@Catatan)"
                                            com.Parameters.AddWithValue("@ID", IDDetail)
                                        Else
                                            com.CommandText = "UPDATE [" & TableMaster & "D] SET
                                                            [IDStokKeluar]=@IDStokKeluar
                                                            ,[NoUrut]=@NoUrut
                                                            ,[IDBarang]=@IDBarang
                                                            ,[Qty]=@Qty
                                                            ,[IDSatuan]= @IDSatuan
