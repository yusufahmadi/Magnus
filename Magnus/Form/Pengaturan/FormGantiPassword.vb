Public Class FormGantiPassword
    ...
    Private Sub btnSimpan_Click(sender As Object, e As EventArgs) Handles btnSimpan.Click
        ...
        If txtNewPwd.Text <> txtReEnterNewPwd.Text Then
            DevExpress.XtraEditors.XtraMessageBox.Show(Me,"Verifikasi password baru harus sama.")
            txtReEnterNewPwd.Focus()
            Exit Sub
        End If
        If Utils.ObjToInt(Query.ExecuteScalar("Select Count(*) From Muser WHere Username='" & Username & "' And Password ='" & AES_Encrypt(txtOldPwd.Text) & "'")) > 0 Then
            ...
            DevExpress.XtraEditors.XtraMessageBox.Show(Me,"Penggantian password berhasil.")
            btnClose.PerformClick()
        Else
            DevExpress.XtraEditors.XtraMessageBox.Show(Me,"Password lama salah.")
        End If
    End Sub
End Class
