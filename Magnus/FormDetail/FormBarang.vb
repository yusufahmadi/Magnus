...
Partial Public Class FormBarang
    ...
    Sub LoadLayoutByRole()
        If IDRoleUser = 1 Then
            ...
            txtL.Visible = True
            txtT.Visible = True
            txtIDSatuanTerbesar.Visible = True
            txtIsi.Visible = True
            txtIDSatuanTerkecil.Visible = True
            txtHargaBeli.Visible = True
            txtProsenUp.Visible = True
            txtHargaJual.Visible = True
        Else
            txtP.Visible = False
            txtL.Visible = False
            txtT.Visible = False
            txtIDSatuanTerbesar.Visible = False
            txtIsi.Visible = False
            txtIDSatuanTerkecil.Visible = False

            'WAJIB DISABLE
            txtHargaBeli.Visible = False
            txtProsenUp.Visible = False
    ...
    Private Sub FormUser_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            If Not ds Is Nothing Then
                ...
                'ds = Query.ExecuteDataSet("Select B.Nama Satuan, A.* from MBarangD A Inner Join MSatuan B On A.IDSatuan=B.ID WHere IDBarang='" & Me._ID & "'")
                'If Not ds Is Nothing Then
    ...
    Function IsValid() As Boolean
        ...
        If Not CBool(ckIsActive.Checked) Then
            If DialogResult.No = MessageBox.Show("Set Barang Non Aktif", AppName, MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) Then
                ckIsActive.Focus()
                res = False
            End If
        End If
