Namespace Reporting
    ...
    Partial Class frmDesignReportDX
        ...
        Private Sub InitializeComponent()
            ...
            Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmDesignReportDX))
            ...
            Me.msiFile.Id = 43
            Me.msiFile.LinksPersistInfo.AddRange(New DevExpress.XtraBars.LinkPersistInfo() {New DevExpress.XtraBars.LinkPersistInfo(DevExpress.XtraBars.BarLinkUserDefines.None, False, Me.CommandBarItem1, False), New DevExpress.XtraBars.LinkPersistInfo(DevExpress.XtraBars.BarLinkUserDefines.None, False, Me.CommandBarItem2, False), New DevExpress.XtraBars.LinkPersistInfo(Me.bbiOpenFile), New DevExpress.XtraBars.LinkPersistInfo(Me.bbiSaveFile, True), New DevExpress.XtraBars.LinkPersistInfo(Me.CommandBarItem3), New DevExpress.XtraBars.LinkPersistInfo(Me.CommandBarItem7), New DevExpress.XtraBars.LinkPersistInfo(Me.CommandBarItem11), New DevExpress.XtraBars.LinkPersistInfo(Me.CommandBarItem4, True)})
            ...
            Me.DesignBar2.LinksPersistInfo.AddRange(New DevExpress.XtraBars.LinkPersistInfo() {New DevExpress.XtraBars.LinkPersistInfo(DevExpress.XtraBars.BarLinkUserDefines.None, False, Me.CommandBarItem1, False), New DevExpress.XtraBars.LinkPersistInfo(Me.bbiOpenFile), New DevExpress.XtraBars.LinkPersistInfo(Me.bbiSaveFile), New DevExpress.XtraBars.LinkPersistInfo(Me.CommandBarItem7), New DevExpress.XtraBars.LinkPersistInfo(Me.bbiCut, True), New DevExpress.XtraBars.LinkPersistInfo(Me.bbiCopy), New DevExpress.XtraBars.LinkPersistInfo(Me.bbiPaste), New DevExpress.XtraBars.LinkPersistInfo(Me.bbiUndo, True), New DevExpress.XtraBars.LinkPersistInfo(Me.bbiRedo)})
        ...
        Friend WithEvents bbiOpenFile As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents bbiSaveFile As DevExpress.XtraReports.UserDesigner.CommandBarItem
        ...
        Friend WithEvents bbiUndo As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents bbiRedo As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents bbiCut As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents bbiCopy As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents bbiPaste As DevExpress.XtraReports.UserDesigner.CommandBarItem
        ...
        Friend WithEvents bbiForeColor As DevExpress.XtraReports.UserDesigner.CommandColorBarItem
        Friend WithEvents bbiBackColor As DevExpress.XtraReports.UserDesigner.CommandColorBarItem
        Friend WithEvents msiFont As DevExpress.XtraBars.BarSubItem
        Friend WithEvents bbiFontBold As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents bbiFontItalic As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents bbiFontUnderline As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents msiJustify As DevExpress.XtraBars.BarSubItem
        Friend WithEvents bbiJustifyLeft As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents bbiJustifyCenter As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents bbiJustifyRight As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents bbiJustifyJustify As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents msiAlign As DevExpress.XtraBars.BarSubItem
        Friend WithEvents bbiAlignLeft As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents bbiAlignVerticalCenters As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents bbiAlignRight As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents bbiAlignTop As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents bbiAlignHorizontalCenters As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents bbiAlignBottom As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents bbiAlignToGrid As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents msiSameSize As DevExpress.XtraBars.BarSubItem
        Friend WithEvents bbiSizeToControlWidth As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents bbiSizeToGrid As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents bbiSizeToControlHeight As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents bbiSizeToControl As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents msiHorizontalSpacing As DevExpress.XtraBars.BarSubItem
        Friend WithEvents bbiHorizSpaceMakeEqual As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents bbiHorizSpaceIncrease As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents bbiHorizSpaceDecrease As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents bbiHorizSpaceConcatenate As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents msiVerticalSpacing As DevExpress.XtraBars.BarSubItem
        Friend WithEvents bbiVertSpaceMakeEqual As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents bbiVertSpaceIncrease As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents bbiVertSpaceDecrease As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents bbiVertSpaceConcatenate As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents bsiCenter As DevExpress.XtraBars.BarSubItem
        Friend WithEvents bbiCenterHorizontally As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents bbiCenterVertically As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents msiOrder As DevExpress.XtraBars.BarSubItem
        Friend WithEvents bbiBringToFront As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents bbiSendToBack As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents msiWindow As DevExpress.XtraBars.BarSubItem
        Friend WithEvents msiWindowInterface As DevExpress.XtraReports.UserDesigner.CommandBarCheckItem
        ...
        Friend WithEvents bbiZoomOut As DevExpress.XtraReports.UserDesigner.CommandBarItem
        Friend WithEvents bbiZoom As DevExpress.XtraReports.UserDesigner.XRZoomBarEditItem
        Friend WithEvents DesignRepositoryItemComboBox2 As DevExpress.XtraReports.UserDesigner.DesignRepositoryItemComboBox
        Friend WithEvents bbiZoomIn As DevExpress.XtraReports.UserDesigner.CommandBarItem
